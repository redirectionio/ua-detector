...
namespace Castor {
    ...
    function event_dispatcher(): \Symfony\Component\EventDispatcher\EventDispatcherInterface
    {
    }
...
namespace Castor\Event {
    ...
    class FunctionsResolvedEvent extends \Symfony\Contracts\EventDispatcher\Event
    {
         ...
         */
        public function __construct(public array $taskDescriptors, public array $symfonyTaskDescriptors, public readonly string $mountPath = '', public readonly bool $isRootMount = true)
        {
        }
    }
